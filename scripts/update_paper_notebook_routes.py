...
def _humanize_existing_markdown(notebook) -> None:
    replacements = {
        ...
        "This notebook loads the packaged panel data, recalculates the displayed summaries, and saves the PDF and PNG. It does not run model training or download external data.": "The calculation cells read the directed-pair, expression, JAM-control, and spatial-null tables, recalculate the displayed summaries, and draw S39. The steps below show how those tables are produced from model and comparison-method outputs.",
        ...
        "# Supplementary Figure S39: interaction evidence": "# Supplementary Figure S42: LR-prior ablation and stVCR comparison",
        "# Supplementary Figure S43: zebrafish attention validation": "# Supplementary Figure S39: zebrafish attention and control comparisons",
