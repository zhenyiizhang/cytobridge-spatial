...
OUT = DATA_ROOT / 'nichenet/new_interpolation/latest_nichenet'
REF = DATA_ROOT / 'admouse_0815/refs/training/adata.h5ad'
STATES = DATA_ROOT / 'nichenet/new_interpolation/results/interpolation/slice_data'
