#!/usr/bin/env python3
"""Reference-style three-panel plot from the formal AdMouse r2 baseline."""
...
FINAL_ROOT = Path(__file__).resolve().parents[3]
...
STEM = OUT / "figures/ad_supplementary1"
CSV_OUT = OUT / "data/ad_supplementary1/admouse_r2_baseline_celltype_counts_and_proportions_first25.csv"
...
# PNG is exported at 900 dpi. In both PNG and PDF, every scatter collection in
# panel a is rasterized; axes, plane borders, labels, and panels b/c stay vector.
fig.savefig(STEM.with_suffix(".png"),dpi=900,bbox_inches="tight")
