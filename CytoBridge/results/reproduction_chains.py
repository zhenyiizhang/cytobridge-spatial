...
FIGURE_REPRODUCTION_CHAINS: dict[str, tuple[dict[str, str], ...]] = {
    ...
    "nonspatial": (
        ...
        _row(
            ...
            "<notebook-run>/nonspatial_figures/outputs/nonspatial_figures/supplementary_figure_s4_weinreb_nonspatial.pdf and supplementary_figure_s5_scnt_nonspatial.pdf, matching PNGs, and derived CSV tables",
            "finished figure",
