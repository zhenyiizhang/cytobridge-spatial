...
FIGURE_WORKFLOWS = (
    ...
    FigureWorkflow(
        ...
        "python scripts/collect_figure_inputs.py s25 --dataset-result zebrafish=<zebrafish-sensitivity> --dataset-result mosta=<mosta-sensitivity> --dataset-result arista=<arista-sensitivity> --dataset-result chicken_heart=<chicken-heart-sensitivity> --output-dir <s25-inputs>",
        "cytobridge figure lr-complex --results-dir <s25-inputs> --output-dir outputs/lr_complex",
        "Redraws S25. The collector accepts the paired score table written by each completed sensitivity run.",
    ),
    FigureWorkflow(
        "zebrafish-si",
    ...
    FigureWorkflow(
        ...
        "scripts/collect_figure_inputs.py",
        "python scripts/collect_figure_inputs.py s39 --no-lr-table <matched-ablation-report>/paired_target_deltas.csv --loto-results-dir <s40-inputs> --output-dir <s39-inputs>",
        "cytobridge figure lr-prior-stvcr --results-dir <s39-inputs> --output-dir outputs/lr_prior_stvcr",
        "Redraws S39 from the completed matched-ablation report and completed LOTO summaries.",
    ),
    FigureWorkflow(
        "loto-benchmark",
        ...
        "scripts/collect_figure_inputs.py",
        "python scripts/collect_figure_inputs.py s40 --dataset-summary zebrafish=<zebrafish-target-summary.csv> --dataset-summary mosta=<mosta-target-summary.csv> --dataset-summary arista=<arista-target-summary.csv> --dataset-summary admouse=<admouse-target-summary.csv> --dataset-summary chicken_heart=<heart-target-summary.csv> --protocol <s40-protocol.json> --output-dir <s40-inputs>",
        "cytobridge figure loto-benchmark --results-dir <s40-inputs> --output-dir outputs/loto_benchmark",
        "Redraws S40 from five completed per-dataset LOTO target summaries.",
    ),
    FigureWorkflow(
        "training-histories",
        ...
        "python scripts/collect_training_history_inputs.py --run zebrafish=<zebrafish-run>/training --run mosta=<mosta-run>/training --run arista=<arista-run>/training --run admouse=<admouse-run>/training --run chicken_heart=<heart-run>/training --output-dir <s42-inputs>",
        "cytobridge figure training-histories --output-dir outputs/training_histories",
        "Redraws S42 from the histories written by completed model runs.",
    ),
    FigureWorkflow(
        ...
        "Redraws S43 after ROI selection and permutation-table calculation.",
    ),
    FigureWorkflow(
        "zebrafish-attention",
        ...
        "Redraws S44 after calculating model and comparison-method outputs.",
    ),
    FigureWorkflow(
        "compute-cost",
