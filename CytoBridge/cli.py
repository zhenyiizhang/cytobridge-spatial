...
_FIGURE_COMMAND_HELP = {
    ...
    "lr-complex": "redraw Supplementary Figure S41",
    "zebrafish-si": "redraw Supplementary Figures S31-S38",
    "interaction-ablation": "redraw Supplementary Figure S42 ablations",
    "lr-prior-stvcr": "redraw the earlier LR-prior and stVCR comparison",
    "loto-benchmark": "redraw Supplementary Figure S45 summaries",
    "training-histories": "redraw Supplementary Figure S46",
    "arista-local-domains": "redraw Supplementary Figure S25 summaries",
